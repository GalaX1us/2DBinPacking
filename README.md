...
### Test protocol
In order to compare the **Hybrid Genetic Algorithm** and the **Tabu Search Algorithm** we decided to run them on entire dataset 100 times and compute the average execution time.
For these tests we used the following parameter :
...
| File Name            | LGFI   | LGFI (shorter leftover) | LGFI (minimum area) | LGFI (hybrid cut) | Hybrid Genetic |      | Tabu Search |       |
| -------------------- | ------ | ----------------------- | ------------------- | ----------------- | -------------- | ---- | ----------- | ----- |
|                      | **Execution time (s)** | **Number of bin**       | **Number of bin**   | **Number of bin** | **Number of bin** | **Execution time (s)** | **Number of bin** | **Execution time (s)** |
| binpacking2d-01.bp2d | 0.0001 | **4**                   | **4**               | **4**             | **4**          | 0.25 | **4**       | 1.48  |
| binpacking2d-02.bp2d | 0.0001 | **6**                   | **6**               | **6**             | **6**          | 0.52 | **6**       | 1.36  |
| binpacking2d-03.bp2d | 0.0001 | 9                       | 9                   | **8**             | **8**          | 1.08 | **8**       | 3.17  |
| binpacking2d-04.bp2d | 0.0001 | 14                      | 15                  | 14                | **13**         | 2.52 | **13**      | 11.78 |
| binpacking2d-05.bp2d | 0.0001 | **3**                   | 4                   | 4                 | **3**          | 0.29 | **3**       | 0.33  |
| binpacking2d-06.bp2d | 0.0001 | 7                       | 7                   | 7                 | **6**          | 0.56 | **6**       | 1.15  |
| binpacking2d-07.bp2d | 0.0001 | 11                      | 12                  | 11                | **10**         | 1.01 | **10**      | 4.03  |
| binpacking2d-08.bp2d | 0.0001 | 14                      | **13**              | **13**            | **13**         | 2.2  | **13**      | 14.12 |
| binpacking2d-09.bp2d | 0.0001 | **3**                   | **3**               | **3**             | **3**          | 0.23 | **3**       | 0.29  |
| binpacking2d-10.bp2d | 0.0001 | 8                       | 8                   | **7**             | **7**          | 0.55 | **7**       | 1.15  |
| binpacking2d-11.bp2d | 0.0001 | **8**                   | 9                   | 9                 | **8**          | 1.13 | **8**       | 3.66  |
| binpacking2d-12.bp2d | 0.0001 | 17                      | 17                  | **15**            | **15**         | 2.42 | **15**      | 13.87 |
| binpacking2d-13.bp2d | 0.0001 | **2**                   | 3                   | **2**             | **2**          | 0.90 | **2**       | 3.00  |

### Hybrid Genetic vs. Tabu Search
**Solution Quality :**
Both algorithms generally converge to solutions with the same number of bins.

**Execution Time :**
The **Tabu Search algorithm is slower** than the Genetic algorithm. 
...
This can be explained by our representation based on LGFI, which leads to a small margin for optimization and quick convergence of the algorithms.
