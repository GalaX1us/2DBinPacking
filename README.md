...
## Comparaison of the 2 implementations

### Test protocol
In order to compare the **Hybrid Genetic Algorithm** and the **Tabu Search Algorithm** we decided to run them on entire dataset with the following parameter :
...
| File Name            | LGFI   | LGFI (shorter leftover) | LGFI (minimum area) | LGFI (custom cut) | Hybrid Genetic |      | Tabu Search |       |
| -------------------- | ------ | ----------------------- | ------------------- | ----------------- | -------------- | ---- | ----------- | ----- |
